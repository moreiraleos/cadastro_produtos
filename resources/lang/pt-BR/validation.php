...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Customização de Mensagens de Validação
    |--------------------------------------------------------------------------
    |
    | Aqui você pode especificar mensagens de validação personalizadas para atributos utilizando
    | a convenção "attribute.rule" para nomear as linhas. Isso ajuda a manter suas
    | mensagens de forma mais organizada e específica.
    |
    */
    ...
    'custom' => [
        'name' => [
            ...
            'unique' => "O nome do produto já está em uso"
        ],
        'qtdEstoque' => [
